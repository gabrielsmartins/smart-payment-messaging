...
public class ValidatedOrderStatusPaymentMethodMessagingProducerMapperTest {


    private ValidatedOrderStatusPaymentMethodMessagingProducerMapper mapper;

    @BeforeEach
    public void setup(){
        this.mapper = new ValidatedOrderStatusPaymentMethodMessagingProducerMapper();
    }
