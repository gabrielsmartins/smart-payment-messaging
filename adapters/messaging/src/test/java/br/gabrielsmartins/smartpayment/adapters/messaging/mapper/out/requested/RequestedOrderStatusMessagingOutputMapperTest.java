...
public class RequestedOrderStatusMessagingOutputMapperTest {

    private RequestedOrderStatusMessagingOutputMapper mapper;

    @BeforeEach
    public void setup(){
        var itemMapper = new RequestedOrderItemStatusMessagingOutputMapper();
        var paymentMethodMapper = new RequestedOrderStatusPaymentMethodMessagingOutputMapper();
        this.mapper = new RequestedOrderStatusMessagingOutputMapper(itemMapper, paymentMethodMapper);
    }
