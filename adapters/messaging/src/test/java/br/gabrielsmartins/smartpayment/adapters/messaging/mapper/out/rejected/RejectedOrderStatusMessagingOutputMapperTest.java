...
public class RejectedOrderStatusMessagingOutputMapperTest {

    private RejectedOrderStatusMessagingOutputMapper mapper;

    @BeforeEach
    public void setup(){
        var itemMapper = new RejectedOrderItemStatusMessagingOutputMapper();
        var paymentMethodMapper = new RejectedOrderStatusPaymentMethodMessagingOutputMapper();
        this.mapper = new RejectedOrderStatusMessagingOutputMapper(itemMapper, paymentMethodMapper);
    }
