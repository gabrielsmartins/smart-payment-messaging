...
public class RejectedOrderStatusMessagingProducerMapperTest {

    private RejectedOrderStatusMessagingProducerMapper mapper;

    @BeforeEach
    public void setup(){
        var itemMapper = new RejectedOrderItemStatusMessagingProducerMapper();
        var paymentMethodMapper = new RejectedOrderStatusPaymentMethodMessagingProducerMapper();
        this.mapper = new RejectedOrderStatusMessagingProducerMapper(itemMapper, paymentMethodMapper);
    }
    ...
    public void givenOrderWhenMapThenReturnMessage(){
        ...
        OrderRejected message = this.mapper.mapToMessage(order);
