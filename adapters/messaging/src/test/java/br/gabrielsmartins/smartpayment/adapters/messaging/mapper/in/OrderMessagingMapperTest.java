...
public class OrderMessagingMapperTest {

    private OrderMessagingMapper mapper;

    @BeforeEach
    public void setup(){
        OrderItemMessagingMapper orderItemMapper = new OrderItemMessagingMapper();
        this.mapper = new OrderMessagingMapper(orderItemMapper);
    }
