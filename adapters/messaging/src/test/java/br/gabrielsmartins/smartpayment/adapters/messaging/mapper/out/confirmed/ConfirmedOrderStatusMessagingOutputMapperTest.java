...
public class ConfirmedOrderStatusMessagingOutputMapperTest {

    private ConfirmedOrderStatusMessagingOutputMapper mapper;

    @BeforeEach
    public void setup(){
        this.mapper = new ConfirmedOrderStatusMessagingOutputMapper();
    }
