...
import br.gabrielsmartins.smartpayment.adapters.messaging.mapper.out.OrderStatusMapperFactory;
...
public class OrderStatusProducer implements SendOrderStatusPort {
    ...
    private final OrderStatusMapperFactory factory;

    @Override
    public void send(Order order) {
        OrderStatusMapper<?> mapper = factory.createMapper(order.getStatus());
